...
/**
 * Created by Sudesi on 05/01/2017.
 */
...
public class ClientDetailsModel implements Serializable {
    ...
    public String getDopeningDate() {
        return dopeningDate;
    }

    public void setDopeningDate(String dopeningDate) {
        this.dopeningDate = dopeningDate;
    }

    public String getDpac() {
        return dpac;
    }

    public void setDpac(String dpac) {
        this.dpac = dpac;
    }
